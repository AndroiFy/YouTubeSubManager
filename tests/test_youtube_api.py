...
def test_get_channel_videos_pagination(mock_youtube_api, mock_translator):
    """
    ...
    # Act
    videos = get_channel_videos(mock_youtube_api, channel_id, mock_translator)
...
def test_upload_caption(mock_media_file_upload, mock_youtube_api, mock_translator):
    """
    ...
    # Act
    upload_caption(mock_youtube_api, video_id, language, file_path, mock_translator)
...
@patch('src.youtube_api.MediaFileUpload')
def test_update_caption_with_id(mock_media_file_upload, mock_youtube_api, mock_translator):
    """
    ...
    # Act
    update_caption(mock_youtube_api, video_id, language, file_path, mock_translator, caption_id=caption_id)
...
def test_update_caption_no_id_found_by_lang(mock_upload_caption, mock_media_file_upload, mock_list_captions, mock_youtube_api, mock_translator):
    """
    ...
    mock_list_captions.return_value = {
        'items': [{'id': 'found_caption_id', 'snippet': {'language': 'en'}}]
    }

    # Act
    update_caption(mock_youtube_api, video_id, language, file_path, mock_translator, caption_id=None)

    # Assert
    mock_list_captions.assert_called_once_with(mock_youtube_api, video_id, mock_translator)
    mock_youtube_api.captions.return_value.update.assert_called_once()
...
@patch('src.youtube_api.MediaFileUpload')
@patch('src.youtube_api.upload_caption')
def test_update_caption_no_id_no_lang_match(mock_upload_caption, mock_media_file_upload, mock_list_captions, mock_youtube_api, mock_translator):
    """
    ...
    mock_list_captions.return_value = {'items': []}
    ...
    mock_upload_caption.assert_called_once_with(mock_youtube_api, video_id, language, file_path, mock_translator)

def test_delete_caption(mock_youtube_api, mock_translator):
    """
    ...
    # Act
    delete_caption(mock_youtube_api, caption_id, mock_translator)
